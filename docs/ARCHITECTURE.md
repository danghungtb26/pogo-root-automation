...
### `app`
Controller APK. The headless service runs the structured runtime controller;
the old screen analyzer/input driver remains only as a legacy calibration path.
